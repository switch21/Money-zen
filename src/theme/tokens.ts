 ...
 *
 * ⚠️  Toutes les clés numériques (50, 100, 200, ..., 900) et alphanumériques
 *     (2xl, 3xl, 4xl) sont quotées car Babel (utilisé par Metro) ne supporte
 *     pas les clés commençant par un chiffre sans guillemets.
 */
...
// Les clés 0, 1, 2, 3, ... sont OK car ce sont des nombres purs (pas d'identifiant après).
// En JS, { 0: 'a', 1: 'b' } est valide (les clés deviennent '0', '1').
